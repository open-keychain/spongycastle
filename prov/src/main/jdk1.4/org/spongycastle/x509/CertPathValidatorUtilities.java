...
class CertPathValidatorUtilities
{
    ...
    */
     ...
     * @throws org.spongycastle.jce.provider.AnnotatedException if a TrustAnchor was found but the signature verification
     ...
     * @throws org.spongycastle.jce.provider.AnnotatedException if the extension cannot be read.
     */
     ...
     *
     * @param certSelect a {@link org.spongycastle.util.Selector} object that will be used to select
     *                   the certificates
     * @param certStores a List containing only {@link org.spongycastle.x509.X509Store} objects. These
     ...
     * {@link org.spongycastle.x509.X509AttributeCertificate}s the issuer may contain more than one
     ...
     * @throws org.spongycastle.jce.provider.AnnotatedException if an exception occurs while processing.
...
//        }
     ...
     * @throws org.spongycastle.jce.provider.AnnotatedException if an exception occurs while picking the delta
     * CRLs.
     */
     ...
     *         CRLs.
     * @throws org.spongycastle.jce.provider.AnnotatedException if an exception occurs while picking the CRLs
     ...
     * @throws org.spongycastle.jce.provider.AnnotatedException if DSA parameters cannot be inherited.
     */
     ...
     * @throws org.spongycastle.jce.provider.AnnotatedException if an error occurs.
     */
