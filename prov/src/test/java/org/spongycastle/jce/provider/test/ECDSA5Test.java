    ...
    extends SimpleTest
{
    ...
    private void testAlgorithmParameters()
        throws Exception
    {
        AlgorithmParameters algParam = AlgorithmParameters.getInstance("EC", "SC");

        algParam.init(new ECGenParameterSpec("P-256"));

        byte[] encoded = algParam.getEncoded();

        algParam = AlgorithmParameters.getInstance("EC", "SC");
    ...
    */
    public void testMQVwithHMACOnePass()
        throws Exception
    {
        AlgorithmParameters algorithmParameters = AlgorithmParameters.getInstance("EC", "SC");
        ...
        KeyFactory keyFact = KeyFactory.getInstance("EC", "SC");
        ...
        KeyAgreement uAgree = KeyAgreement.getInstance("ECMQVwithSHA512CKDF", "SC");
        ...
        KeyAgreement vAgree = KeyAgreement.getInstance("ECMQVwithSHA512CKDF", "SC");
