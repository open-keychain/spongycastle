    ...
    extends SimpleTest
{
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException
    {
        Signature sig;
        byte[] sigBytes;
        sig = Signature.getInstance(algorithm, "SC");
        ...
        throws Exception
    {
        ...
        Signature signer = Signature.getInstance("SHA1withRSA/X9.31", "SC");

        signer.initVerify(KeyFactory.getInstance("RSA", "SC").generatePublic(rsaPublic));
        ...
        throws Exception
    {
        ...
        RSAPublicKeySpec rsaPublic = new RSAPublicKeySpec(n, e);
        Signature signer = Signature.getInstance("SHA224withRSA/X9.31", "SC");
        ...
        throws Exception
    {
        ...
        PrivateKey privateKey = KeyFactory.getInstance("RSA", "SC").generatePrivate(rsaPriv);
        PublicKey publicKey = KeyFactory.getInstance("RSA", "SC").generatePublic(rsaPublic);
    ...
    private void doGenVerify(String algorithm, PrivateKey privateKey, PublicKey publicKey, byte[] msg, byte[] sig)
        throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, SignatureException
    {
        Signature signer = Signature.getInstance(algorithm, "SC");
