...
class TestUtils
{
        ...
        throws Exception
    {
        ...
        Signature sig = Signature.getInstance(sigName, "SC");
        ...
        return (X509Certificate)CertificateFactory.getInstance("X.509", "SC").generateCertificate(new ByteArrayInputStream(new DERSequence(v).getEncoded(ASN1Encoding.DER)));
    }
