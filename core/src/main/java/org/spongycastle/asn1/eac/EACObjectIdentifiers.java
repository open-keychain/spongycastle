...
public interface EACObjectIdentifiers
{
    ...
    static final ASN1ObjectIdentifier    id_TA_EDDSA_SHA_1      = id_TA_ECDSA.branch("1");
    /** OID: 0.4.0.127.0.7.2.2.2.3.2 */
    static final ASN1ObjectIdentifier    id_TA_EDDSA_SHA_224    = id_TA_ECDSA.branch("2");
    /** OID: 0.4.0.127.0.7.2.2.2.3.3 */
    static final ASN1ObjectIdentifier    id_TA_EDDSA_SHA_256    = id_TA_ECDSA.branch("3");
    /** OID: 0.4.0.127.0.7.2.2.2.3.4 */
    static final ASN1ObjectIdentifier    id_TA_EDDSA_SHA_384    = id_TA_ECDSA.branch("4");
    /** OID: 0.4.0.127.0.7.2.2.2.3.5 */
    static final ASN1ObjectIdentifier    id_TA_EDDSA_SHA_512    = id_TA_ECDSA.branch("5");
