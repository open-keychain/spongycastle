    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        InputDecryptorProvider pkcs8Prov = new JceOpenSSLPKCS8DecryptorProviderBuilder().setProvider("SC").build("password".toCharArray());
    ...
    private void doOpenSslTestFile(
        ...
        throws IOException
    {
        keyDecryptTest(fileName, expectedPrivKeyClass, new JcePEMDecryptorProviderBuilder().setProvider("SC").build("changeit".toCharArray()));
