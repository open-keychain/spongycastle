    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        if (!spkac.isSignatureValid(new JcaContentVerifierProviderBuilder().setProvider("SC").build(spkac.getSubjectPublicKeyInfo())))
        {
            fail(testName + " verification failed");
        }
        ...
        if (!spkac.isSignatureValid(new JcaContentVerifierProviderBuilder().setProvider("SC").build(jcaSignedPublicKeyAndChallenge.getPublicKey())))
        {
            fail(testName + " verification failed");
        }
    }
