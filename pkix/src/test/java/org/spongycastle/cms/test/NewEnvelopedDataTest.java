...
//    }
   ...
   public void testKeyTransCAST5()
        ...
        throws Exception
    {
        ...
        X509Certificate x509Certificate = new JcaX509CertificateConverter().setProvider("SC").getCertificate((X509CertificateHolder)pemParser.readObject());
        ...
        throws CMSException, IOException
    {
        ...
        byte[] decrypted = recip.getContent(new JceKeyAgreeEnvelopedRecipient(ecKey).setProvider("SC"));
