...
class CMSSignedHelper
{
    ...
    static
    {
        ...
        addEntries(X9ObjectIdentifiers.eddsa_with_SHA1, "SHA1", "EDDSA");
        addEntries(X9ObjectIdentifiers.eddsa_with_SHA224, "SHA224", "EDDSA");
        addEntries(X9ObjectIdentifiers.eddsa_with_SHA256, "SHA256", "EDDSA");
        addEntries(X9ObjectIdentifiers.eddsa_with_SHA384, "SHA384", "EDDSA");
        addEntries(X9ObjectIdentifiers.eddsa_with_SHA512, "SHA512", "EDDSA");
        ...
        addEntries(EACObjectIdentifiers.id_TA_EDDSA_SHA_1, "SHA1", "EDDSA");
        addEntries(EACObjectIdentifiers.id_TA_EDDSA_SHA_224, "SHA224", "EDDSA");
        addEntries(EACObjectIdentifiers.id_TA_EDDSA_SHA_256, "SHA256", "EDDSA");
        addEntries(EACObjectIdentifiers.id_TA_EDDSA_SHA_384, "SHA384", "EDDSA");
        addEntries(EACObjectIdentifiers.id_TA_EDDSA_SHA_512, "SHA512", "EDDSA");
